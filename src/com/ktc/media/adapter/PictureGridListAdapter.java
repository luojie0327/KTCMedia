...
public class PictureGridListAdapter extends RecyclerView.Adapter<PictureGridListAdapter.ViewHolder>
    ...
    public PictureGridListAdapter(Context context, List<FileData> dataList) {
        mContext = context;
        mDataList = dataList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_picture_grid_list_layout, viewGroup, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView) {
            super(itemView);
            mMediaGridItemView = (MediaGridItemView) itemView.findViewById(R.id.picture_grid_list_item);
        }
    }
}
