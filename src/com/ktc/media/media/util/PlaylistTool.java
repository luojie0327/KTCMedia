...
public class PlaylistTool {
    ...
    private ArrayList<FileData> basedataList = new ArrayList<>();
    private FileData mFileData = null;

    public ArrayList<FileData> parsePlaylist(String xmlfile) {
        try {
