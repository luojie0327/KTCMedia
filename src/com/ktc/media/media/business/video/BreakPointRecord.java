...
public class BreakPointRecord {
     ...
     * Inquires the record.
     */
    public static synchronized int getData(String path, Context context) {
        if (dbAdapter == null) {
        ...
        BreakPointInfo[] breakPoint = dbAdapter.queryOneData(path);
        if (breakPoint != null) {
    ...
    public static void AddDataThread(final String path, final int time, final Context context) {
        Thread AddDataThread = new Thread(new Runnable() {
            public void run() {
                Log.i("BreakPointRecord", "AddDataThread start to addData");
                addData(path, time, context);
            }
        });
     ...
     * Add the record.
     */
    public static synchronized void addData(final String path, final int time, final Context context) {
        ...
        dbAdapter.deleteOneData(encodePath);
