...
public class ImagePlayerViewHolder {
    ...
    protected RelativeLayout mImagePlayerLayout;
    ...
    void findViews() {
        mImagePlayerLayout = (RelativeLayout) mImagePlayerActivity.findViewById(R.id.image_player_layout);
        mSurfaceView = (ImagePlayerSurfaceView) mImagePlayerActivity.findViewById(R.id.image_surface_view);
        mMediaControllerView = (MediaControllerView) mImagePlayerActivity.findViewById(R.id.image_player_controller_view);
    }
